...
import com.giftedcat.picture.lib.selector.adapter.FolderAdapter;
import com.giftedcat.picture.lib.selector.adapter.ImageGridAdapter;
import com.giftedcat.picture.lib.selector.bean.Folder;
import com.giftedcat.picture.lib.selector.bean.Image;
import com.giftedcat.picture.lib.selector.utils.FileUtils;
import com.giftedcat.picture.lib.selector.utils.ScreenUtils;
...
public class MultiImageSelectorFragment extends Fragment {
    ...
    private void showCameraAction() {
        if (ContextCompat.checkSelfPermission(getContext(), perms[0])
                != PackageManager.PERMISSION_GRANTED || ContextCompat.checkSelfPermission(getContext(), perms[1])
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    startCameraActivity(intent, mTmpFile);
                } else {
    ...
    private void requestPermission(final String[] permissions, String rationale, final int requestCode) {
